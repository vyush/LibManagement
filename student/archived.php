<?php include 'header.php';?>
                    ...
                    <div class="alert alert-primary" role="alert">
                                    ...
                                    <strong><i class="icon-info-sign icon-large"></i>&nbsp;These books are rare or in bad conditon so can be used in library only and cannot be issued.</strong>
                        </div>
                        <ul class="nav nav-pills nav-justified" >
                            <li ><a href="book.php">All</a></li>
                            <li ><a href="new_books.php">New Books</a></li>
                            <li><a href="old_books.php">Old Books</a></li>
                            <li class="active"><a href="archived.php">Archived Books</a></li>
                        </ul>
                        <center class="title">
						<h1>Books List</h1>
						</center>
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example"  width="100%" style="border-collapse: collapse">
                                ...
                                <tbody>
                                  ...
                                  <?php 
								    ...
								    $user_query=mysqli_query($conn,"select * from book WHERE status = 'Archived'");
