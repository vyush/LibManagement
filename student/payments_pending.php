<?php include 'header.php';?>
                    <div class="span12" >
                        <ul class="nav nav-pills nav-justified" >
                            ...
                            <li class="active"><a href="payments_pending.php">Payments Pending</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example"  width="100%" style="border-collapse: collapse">
                                ...
                                <tbody>
                                  ...
                                  <?php 
								    ...
								    $user_query=mysqli_query($conn,"select * from payment where user_id = '$id' and Status = 'NOT APPROVED'");
