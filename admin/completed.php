<?php include 'header.php';?>
                    <div class="span12" >
                        <ul class="nav nav-pills nav-justified" >
                            ...
                            <li class="active"><a href="completed.php">Completed Requests</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example"  width="100%" style="border-collapse: collapse">
                                ...
                                <tbody>
                                  ...
                                  <?php 
                                    ...
                                    $user_query=mysqli_query($conn,"select * from transaction where return_status = 'ACCEPTED' OR return_status = 'RETURNED' OR return_status = 'DENIED'");
									while($row=mysqli_fetch_array($user_query)){
                                        ...
                                        <a href='acceptbookreq.php?type='.$status class='btn btn-success' >ACCEPT</a>
    
                                        <a href='rejectbookreq.php?id='$status class='btn btn-success' style = 'background-color:#ff0000; color:#fff'>DECLINE</a>";
