<?php include 'header.php';?>
                    <div class="span12" >
                        <ul class="nav nav-pills nav-justified" >
                            ...
                            <li class="active"><a href="accepted_user.php">Accepted Users</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example"  width="100%" style="border-collapse: collapse">
                                ...
                                <tbody>
                                  ...
                                  <?php 
								    ...
								    $user_query=mysqli_query($conn,"select * from users WHERE approval_status = 'ACCEPTED'; ");
                                    ...
                                    <?php
                                      	if($status == "NOT ACCEPTED" && $role = "Student")
                                      		echo "<a href=\"join_request.php?id=".$id."\" class=\"btn btn-success\">Issue</a>";
                                    ?>
